                    ...
                    {message.sender === 'bot' && (
                      <div className="flex items-center justify-end mt-2 space-x-2">
                        <button
                          ...
                          className={`p-1 rounded-full hover:bg-background/20 transition-colors duration-200 ${message.rating === 'up' ? 'text-green-500' : ''}`}
                        >
                          <ThumbsUp size={14} />
                        </button>
                        <button
                          onClick={() => rateMessage(message.id, 'down')}
                          className={`p-1 rounded-full hover:bg-background/20 transition-colors duration-200 ${message.rating === 'down' ? 'text-red-500' : ''}`}
                        >
                          <ThumbsDown size={14} />
                        </button>
                        <button
